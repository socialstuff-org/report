...
\usepackage{wrapfig}		          % Allows to align an image left or right
...
\makechapterstyle{mychapterstyle}{
    ...
    \patchcommand{\printchaptername}{\begingroup\color{plumViolot}}{\endgroup}
    \renewcommand*{\chapternamenum}{\space\space}
    \patchcommand{\printchapternum}{\begingroup\color{coralRed}}{\endgroup}
    ...
    \AddToShipoutPicture*{
        \put(0,0){
            \parbox[b][\paperheight]{\paperwidth}{%
                \includegraphics[scale=2.5]{fontys}
                \vspace*{2.5cm}
            }
        }
    }
